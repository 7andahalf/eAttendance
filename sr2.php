...
<body bgcolor="#FFFF99">
<?php if($step == "0"){ ?>
<h1><center>Show Report(Without Attendance Data)</center></h1><hr />
You are here: <a href="index.php">Home</a> > <a href="sr2.php">Show Report(Without Attendance Data)</a> ><b> Step 1</b>
<hr />
<?php  echo($mess); ?>
...
<table width="100%" border="1" class="data">
  <tr>
    <td colspan="9" bgcolor="#CCCCCC"><h1><b><center>Attendance report(Without Attendance Data)</center></b></h1></td>
  </tr>
  <tr>
